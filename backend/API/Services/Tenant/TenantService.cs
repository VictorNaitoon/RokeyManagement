...
using PagoSuscripcionModel = API.Models.PagoSuscripcion;

namespace API.Services.Tenant
{
    public interface ITenantService
    {
        Task<(Negocio? negocio, Usuario? usuario, SuscripcionModel? suscripcion, string? error)> CreateTenantAsync(
            string email, 
            string password, 
            string nombre, 
            string apellido,
        ...
        Task<(SuscripcionModel? suscripcion, string? error)> CreateSuscripcionAsync(
            int idNegocio,
            int idPlan,
            string tipoFacturacion,
            bool esTrial = false);

        Task<(PagoSuscripcionModel? pago, string? error)> ProcessPaymentAsync(
            int idSuscripcion,
            string metodoPago,
            string? paymentToken);
    }
    ...
    public class TenantService : ITenantService
    {
        ...
        public async Task<(Negocio? negocio, Usuario? usuario, SuscripcionModel? suscripcion, string? error)> CreateTenantAsync(
            string email,
            string password,
            string nombre,
            string apellido,
        ...
        public async Task<(SuscripcionModel? suscripcion, string? error)> CreateSuscripcionAsync(
            int idNegocio,
            int idPlan,
            string tipoFacturacion,
            bool esTrial = false)
        ...
        public async Task<(PagoSuscripcionModel? pago, string? error)> ProcessPaymentAsync(
            int idSuscripcion,
            string metodoPago,
            string? paymentToken)
        {
