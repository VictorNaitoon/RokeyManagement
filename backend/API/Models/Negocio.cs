...
namespace API.Models
{
    ...
    public class Negocio
    {
        ...
        /// <summary>
        /// Límite de carritos internos activos por vendedor (por usuario). Default: 5
        /// </summary>
        public int? LimiteCarritosActivos { get; set; }
        ...
        // --- CARRITO INTERNO ---
        public ICollection<CarritoInterno>? CarritosInternos { get; set; }
    }
}
